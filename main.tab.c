...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_calculation_disc = 27,          /* calculation_disc  */
  YYSYMBOL_operators_list = 28,            /* operators_list  */
  YYSYMBOL_operator = 29,                  /* operator  */
  YYSYMBOL_assignment = 30,                /* assignment  */
  YYSYMBOL_expression = 31,                /* expression  */
  YYSYMBOL_unexpression = 32,              /* unexpression  */
  YYSYMBOL_bin_op = 33,                    /* bin_op  */
  YYSYMBOL_operand = 34,                   /* operand  */
  YYSYMBOL_complex_op = 35,                /* complex_op  */
  YYSYMBOL_cycle_op = 36,                  /* cycle_op  */
  YYSYMBOL_compose_op = 37                 /* compose_op  */
};
...
{
       0,   233,   233,   243,   244,   250,   251,   254,   255,   256,
     258,   259,   261,   262,   263,   264,   265,   266,   267,   270,
...
{
  "\"end of file\"", "error", "\"invalid token\"", "IDENT", "CONST",
  "VAR", "EQ", "UNARY", "WHILE", "DO", "BEGIN_T", "END", "';'", "','",
  "'='", "'-'", "'('", "')'", "'+'", "'*'", "'/'", "'<'", "'>'", "$accept",
  "program", "vars", "var_list", "calculation_disc", "operators_list",
  "operator", "assignment", "expression", "unexpression", "bin_op",
  "operand", "complex_op", "cycle_op", "compose_op", YY_NULLPTR
};
...
{
      -2,     1,    13,    20,    12,    -2,   -23,    17,     5,    20,
      14,   -23,    20,   -23,   -23,   -23,   -23,     1,   -23,     5,
     -23,   -23,     3,     3,     5,    23,    -4,   -23,    18,   -23,
     -23,   -23,   -23,    -4,    -4,    16,    20,   -23,   -23,   -23,
     -23,   -23,   -23,   -23,     3,   -23,   -23,   -23,    -4
};
...
{
       0,     0,     0,     0,     5,     3,     1,     0,     0,     0,
       0,     7,     8,    10,    11,    28,    29,     0,     4,     0,
      26,    27,     0,     0,     0,     0,    15,    17,     0,     2,
       9,     6,    12,    13,    14,     0,     0,    25,    19,    20,
      21,    22,    23,    24,     0,    31,    16,    30,    18
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -23,   -23,    29,    19,   -23,    15,    -1,   -23,   -14,   -22,
     -23,   -23,   -23,   -23,   -23
};
...
{
      33,    34,    37,     1,     4,    32,    20,    21,    20,    21,
      35,    38,    22,     6,    39,    40,    41,    42,    43,    24,
      23,    24,    48,     7,    28,    17,    29,    30,     8,    45,
       9,    19,    36,    46,    18,    47,    31
};

static const yytype_int8 yycheck[] =
{
      22,    23,     6,     5,     3,    19,     3,     4,     3,     4,
      24,    15,     7,     0,    18,    19,    20,    21,    22,    16,
      15,    16,    44,     3,     9,    13,    12,    12,     8,    11,
      10,    14,     9,    17,     5,    36,    17
};
...
{
       0,     5,    24,    25,     3,    26,     0,     3,     8,    10,
      27,    28,    29,    30,    35,    36,    37,    13,    25,    14,
       3,     4,     7,    15,    16,    31,    32,    34,    28,    12,
      28,    26,    31,    32,    32,    31,     9,     6,    15,    18,
      19,    20,    21,    22,    33,    11,    17,    29,    32
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* program: vars calculation_disc ';'  */
#line 233 "./main.y"
...
#line 1341 "main.tab.c"
  ...
  case 3: /* vars: VAR var_list  */
#line 243 "./main.y"
                   {(yyval.node) = (yyvsp[0].node);}
#line 1347 "main.tab.c"
    break;

  case 4: /* vars: VAR var_list vars  */
#line 244 "./main.y"
...
#line 1370 "main.tab.c"
  ...
  case 7: /* calculation_disc: operators_list  */
#line 254 "./main.y"
                                 {(yyval.node)=new_tree_node("Calculations", (yyvsp[0].node), NULL);}
#line 1376 "main.tab.c"
    break;

  case 8: /* operators_list: operator  */
#line 255 "./main.y"
                         {(yyval.node)=(yyvsp[0].node);}
#line 1382 "main.tab.c"
    break;

  case 9: /* operators_list: operator operators_list  */
#line 256 "./main.y"
                                      {(yyval.node)=(yyvsp[-1].node);
                                        (yyval.node)->next = (yyvsp[0].node);}
#line 1389 "main.tab.c"
  ...
  case 10: /* operator: assignment  */
#line 258 "./main.y"
                     {(yyval.node)=new_tree_node("=", (yyvsp[0].node), NULL);}
#line 1395 "main.tab.c"
    break;

  case 11: /* operator: complex_op  */
#line 259 "./main.y"
                     {(yyval.node)=(yyvsp[0].node);}
#line 1401 "main.tab.c"
    break;

  case 12: /* assignment: IDENT '=' expression  */
#line 261 "./main.y"
                                 {(yyval.node)=new_tree_node((yyvsp[-2].text), NULL, (yyvsp[0].node));}
#line 1407 "main.tab.c"
    break;

  case 13: /* expression: UNARY unexpression  */
#line 262 "./main.y"
                               {(yyval.node)=new_tree_node("not", (yyvsp[0].node), NULL);}
#line 1413 "main.tab.c"
    break;

  case 14: /* expression: '-' unexpression  */
#line 263 "./main.y"
                           {(yyval.node)=new_tree_node("-", (yyvsp[0].node), NULL);}
#line 1419 "main.tab.c"
    break;

  case 15: /* expression: unexpression  */
#line 264 "./main.y"
                       {(yyval.node)=(yyvsp[0].node);}
#line 1425 "main.tab.c"
    break;

  case 16: /* unexpression: '(' expression ')'  */
#line 265 "./main.y"
                                 {(yyval.node)=(yyvsp[-1].node);}
#line 1431 "main.tab.c"
    break;

  case 17: /* unexpression: operand  */
#line 266 "./main.y"
                  {(yyval.node)=(yyvsp[0].node);}
#line 1437 "main.tab.c"
    break;

  case 18: /* unexpression: unexpression bin_op unexpression  */
#line 267 "./main.y"
                                           {(yyval.node)=(yyvsp[-1].node);
...
#line 1518 "main.tab.c"
  ...
  case 31: /* compose_op: BEGIN_T operators_list END  */
#line 284 "./main.y"
                                       {(yyval.node)=(yyvsp[-1].node);}
#line 1524 "main.tab.c"
    break;
