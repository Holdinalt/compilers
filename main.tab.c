...
{
       0,   236,   236,   246,   247,   253,   254,   257,   258,   259,
     261,   262,   264,   265,   266,   267,   268,   269,   270,   273,
...
{
  "$end", "error", "$undefined", "IDENT", "CONST", "VAR", "EQ", "UNARY",
  "WHILE", "DO", "BEGIN_T", "END", "';'", "','", "'='", "'-'", "'('",
  "')'", "'+'", "'*'", "'/'", "'<'", "'>'", "$accept", "program", "vars",
  "var_list", "calculation_disc", "operators_list", "operator",
  "assignment", "expression", "unexpression", "bin_op", "operand",
  "complex_op", "cycle_op", "compose_op", YY_NULLPTR
};
#endif
...
static const yytype_int16 yytoknum[] =
{
     ...
     265,   266,    59,    44,    61,    45,    40,    41,    43,    42,
      47,    60,    62
};
# endif
...
#line 1671 "main.tab.c"
    break;

  case 19:
#line 273 "main.y"
            {(yyval.node)=new_tree_node("-", NULL, NULL);}
#line 1677 "main.tab.c"
    break;

  case 20:
#line 274 "main.y"
          {(yyval.node)=new_tree_node("+", NULL, NULL);}
#line 1683 "main.tab.c"
    break;
...
#line 276 "main.y"
          {(yyval.node)=new_tree_node("/", NULL, NULL);}
#line 1695 "main.tab.c"
    break;

  case 23:
#line 277 "main.y"
          {(yyval.node)=new_tree_node("<", NULL, NULL);}
#line 1701 "main.tab.c"
    break;

  case 24:
#line 278 "main.y"
          {(yyval.node)=new_tree_node(">", NULL, NULL);}
#line 1707 "main.tab.c"
    break;

  case 25:
#line 279 "main.y"
         {(yyval.node)=new_tree_node("==", NULL, NULL);}
#line 1713 "main.tab.c"
    break;

  case 26:
#line 280 "main.y"
               {(yyval.node) = new_tree_node((yyvsp[0].text), NULL, NULL);}
#line 1719 "main.tab.c"
    break;
...
#line 285 "main.y"
                                       {(yyval.node)=new_tree_node("while", (yyvsp[-2].node), NULL);
                                        (yyval.node)->child->next = (yyvsp[0].node);}
#line 1744 "main.tab.c"
    break;

  case 31:
#line 287 "main.y"
                                       {(yyval.node)=(yyvsp[-1].node);}
#line 1750 "main.tab.c"
    break;
